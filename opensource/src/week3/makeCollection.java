...
class makeCollection {
	public void collection (String addr) {
		try {
			File dir = new File(addr);//검색할 디렉토리
			...
			StreamResult result = new StreamResult(new FileOutputStream(new File("../week3/collection.xml")));
